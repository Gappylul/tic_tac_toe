defmodule TicTacToeWeb.ConnCase do
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    ...
    scope = TicTacToe.Accounts.Scope.for_user(user)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = TicTacToe.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    TicTacToe.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
